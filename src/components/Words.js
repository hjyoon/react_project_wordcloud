        ...
        return (
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="단어" type="text" name="word" value={this.state.word} onChange={this.handleValueChange}></TextField><br/>
                        <TextField label="가중치(1부터 9까지)" type="text" name="weight" value={this.state.weight} onChange={this.handleValueChange}></TextField><br/>
                    </DialogContent>
                    <DialogActions>
